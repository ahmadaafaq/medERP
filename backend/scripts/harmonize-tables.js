...
async function migrate() {
  ...
  for (const s of schemasRes.rows) {
    ...
    console.log(`Harmonizing tables for ${schema}...`);
    ...
    await c.query(`
      ...
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS drive_id SERIAL;
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS id UUID DEFAULT gen_random_uuid();
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS company_name VARCHAR(255);
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS role VARCHAR(255);
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS package_ctc VARCHAR(100);
      ...
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS description TEXT;
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS eligibility_course_cd VARCHAR(50);
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS eligibility_branch_cd VARCHAR(100);
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS eligibility_batch_cd VARCHAR(100);
      ...
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS min_score_required NUMERIC(5,2) DEFAULT 60.00;
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS drive_date DATE;
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS deadline_date TIMESTAMPTZ;
      ...
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS status VARCHAR(50) DEFAULT 'Open';
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS created_by_empid VARCHAR(100);
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();
      ALTER TABLE "${schema}".placement_drives ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
    `);

    // 2. Drive Companies (For drive batches)
    await c.query(`
    ...
    await c.query(`
      ...
      ALTER TABLE "${schema}".placement_applications ADD COLUMN IF NOT EXISTS id UUID DEFAULT gen_random_uuid();
      ALTER TABLE "${schema}".placement_applications ADD COLUMN IF NOT EXISTS company_id UUID;
    ...
    // 4. Internship Programs, Applications & Certificates
    await c.query(`
    ...
    console.log(`Schema ${schema} successfully upgraded & synchronized!`);
  }
