  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (appRes.ok) {
        ...
        setApplicants(Array.isArray(rawApp) ? rawApp : []);
      }
    } catch (e) {
                                ...
                                <tr key={app.student_id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors">
                                  ...
                                  <td className="py-3.5 px-4">
                                    {isLocked ? (
                                      ...
                                      <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-amber-50 text-amber-700 dark:bg-amber-950 dark:text-amber-300 border border-amber-200">
                                        IN PROGRESS
                                      </span>
                                    )}
                                  </td>
