...
import NoticeBadge from './notices/NoticeBadge';
        ...
        <nav className="space-y-2 text-xs font-medium pr-1">
          {role === 'admin' ? (
            <>
              ...
              {/* Notices & Circulars Admin Section */}
              <div className="pt-2 pb-1 border-t border-white/10 mt-2">
                <span className="text-[10px] uppercase tracking-wider font-extrabold text-[#F36C21] px-2 block mb-1">
                  Notices & Circulars
                </span>
                <Link href="/dashboard/admin/notices/compose" className={getLinkClass('/dashboard/admin/notices/compose')}>
                  <svg className="w-4 h-4 shrink-0 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                  </svg>
                  <span>Compose Notice</span>
                </Link>
                <Link href="/dashboard/admin/notices/sent" className={getLinkClass('/dashboard/admin/notices/sent')}>
                  <svg className="w-4 h-4 shrink-0 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                  </svg>
                  <span>Sent Notices</span>
                </Link>
                <Link href="/dashboard/admin/notices/groups" className={getLinkClass('/dashboard/admin/notices/groups')}>
                  <svg className="w-4 h-4 shrink-0 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  <span>Notice Groups</span>
                </Link>
              </div>
            </>
          ) : role === 'faculty' ? (
            ...
            <>
              ...
              <Link href="/dashboard/warden/notices" className={getLinkClass('/dashboard/warden/notices')}>
                <svg className="w-4 h-4 shrink-0 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
                </svg>
                <div className="flex-1 flex items-center justify-between">
