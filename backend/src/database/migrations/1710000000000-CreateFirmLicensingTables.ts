...
export class CreateFirmLicensingTables1710000000000 implements MigrationInterface {
  name = 'CreateFirmLicensingTables1710000000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_firms_slug ON public.firms (slug);`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_firms_status ON public.firms (status);`);
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_license_keys_firm_id ON public.license_keys (firm_id);`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_license_keys_status ON public.license_keys (status);`);
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_transactions_firm_id ON public.transactions (firm_id);`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_transactions_ref ON public.transactions (transaction_ref);`);
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_menu_registry_role_mode ON public.menu_registry (role, applicable_firm_mode);`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_menu_registry_parent ON public.menu_registry (parent_menu_key);`);
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_firm_role_perm_firm_role ON public.firm_role_permissions (firm_id, role);`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE IF EXISTS public.firm_role_permissions CASCADE;`);
    await queryRunner.query(`DROP TABLE IF EXISTS public.menu_registry CASCADE;`);
    await queryRunner.query(`DROP TABLE IF EXISTS public.transactions CASCADE;`);
    await queryRunner.query(`DROP TABLE IF EXISTS public.license_keys CASCADE;`);
    await queryRunner.query(`DROP TABLE IF EXISTS public.firms CASCADE;`);
  }
}
