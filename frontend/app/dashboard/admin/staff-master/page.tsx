  ...
  return (
    <div className="flex min-h-screen bg-[#F6F8FC] text-[#1B1E28] font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-6 space-y-6 flex-1 bg-[#F6F8FC]">
          {alert && (
            <div className={`p-4 rounded-2xl border text-xs font-extrabold transition-all shadow-sm animate-fade-in flex items-center gap-2 ${
              alert.type === 'success' 
          ...
          {/* Filters Bar */}
          <div className="p-5 rounded-[22px] bg-white border border-[#E7EAF3] shadow-sm hover:shadow-md transition-all flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
              <div className="relative w-full sm:w-64">
                <input
                  ...
                  className="px-4 py-2.5 text-xs rounded-xl bg-[#F6F8FC] border border-[#E7EAF3] focus:outline-none focus:border-[#5B4BFF] focus:ring-2 focus:ring-[#5B4BFF]/10 w-full text-[#1B1E28] placeholder:text-[#9BA5B5] transition-all pl-9 font-medium"
                />
                <svg className="w-4 h-4 text-[#9BA5B5] absolute left-3 top-3" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                </svg>
              </div>
              
              {metadataLoading ? (
                <div className="h-9 w-36 bg-[#F6F8FC] animate-pulse rounded-xl border border-[#E7EAF3]"></div>
              ) : (
                <select
                  value={selectedDept}
                  onChange={(e) => { setSelectedDept(e.target.value); setCurrentPage(1); }}
                  className="px-3.5 py-2.5 text-xs rounded-xl bg-[#F6F8FC] border border-[#E7EAF3] focus:outline-none focus:border-[#5B4BFF] text-[#1B1E28] font-medium"
                >
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#2D2575] to-[#5B4BFF] hover:from-[#3A2F8A] hover:to-[#7867FF] text-white font-extrabold text-xs flex items-center gap-2 shadow-md shadow-[#5B4BFF]/20 border border-white/10 hover:scale-[1.02] active:scale-[0.98] transition-all w-full md:w-auto justify-center"
            >
          ...
          {/* Staff Roster Table */}
          <div className="bg-white border border-[#E7EAF3] rounded-[22px] overflow-hidden shadow-sm hover:shadow-md transition-all">
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className="border-b border-[#E7EAF3] text-white font-extrabold uppercase text-[10px] tracking-wider bg-gradient-to-r from-[#2D2575] via-[#3A2F8A] to-[#5B4BFF]">
                ...
                <tbody className="divide-y divide-[#E7EAF3]">
                  {loading ? (
                      ...
                      <tr key={idx} className="animate-pulse bg-white">
                        <td className="pl-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-[#EEF2FF]"></div>
                            <div className="space-y-2">
                              <div className="h-3.5 bg-[#F6F8FC] rounded w-28"></div>
                              <div className="h-2.5 bg-[#F6F8FC] rounded w-16"></div>
                            </div>
                          </div>
                        </td>
                        <td className="py-4"><div className="h-3 bg-[#F6F8FC] rounded w-14"></div></td>
                        <td className="py-4"><div className="h-5 bg-[#F6F8FC] rounded w-20"></div></td>
                        <td className="py-4">
                          <div className="space-y-1.5">
                            <div className="h-3 bg-[#F6F8FC] rounded w-24"></div>
                            <div className="h-2.5 bg-[#F6F8FC] rounded w-16"></div>
                          </div>
                        </td>
                        <td className="py-4">
                          <div className="space-y-1.5">
                            <div className="h-3 bg-[#F6F8FC] rounded w-20"></div>
                            <div className="h-2.5 bg-[#F6F8FC] rounded w-14"></div>
                          </div>
                        </td>
                        <td className="py-4"><div className="h-4 bg-[#F6F8FC] rounded w-12"></div></td>
                        <td className="pr-6 py-4 text-right">
                          <div className="flex justify-end gap-1.5">
                            <div className="w-7 h-7 bg-[#F6F8FC] rounded-lg"></div>
                            <div className="w-7 h-7 bg-[#F6F8FC] rounded-lg"></div>
                          </div>
                        </td>
                      </tr>
                    ...
                    <tr>
                      <td colSpan={7} className="py-12 text-center text-[#7B8794] font-medium">
                        No staff records found matching the active filters.
                      </td>
                    </tr>
                  ) : (
                    paginatedFaculties.map((fac) => (
                      <tr key={fac.id} className="hover:bg-[#F6F8FC] transition-colors group">
                        <td className="pl-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-[#EEF2FF] border border-[#5B4BFF]/20 flex items-center justify-center overflow-hidden shrink-0 shadow-sm group-hover:border-[#5B4BFF] transition-colors p-0.5">
                            ...
                            <div>
                              <p className="font-bold text-[#1B1E28] tracking-tight text-sm">{fac.name}</p>
                              <p className="text-[11px] text-[#5B4BFF] font-semibold">{fac.designation || 'Staff Member'}</p>
                            </div>
                          </div>
                        </td>
                        <td className="py-4 font-mono font-bold text-[#2D2575]">
                          <span className="bg-[#EEF2FF] px-2.5 py-1 rounded-lg border border-[#5B4BFF]/20 text-xs">
                            {fac.emp_id}
                          </span>
                        </td>
                        <td className="py-4">
                          <div className="space-y-1">
                            <span className="px-2.5 py-0.5 rounded-md bg-[#EEF2FF] text-[#5B4BFF] border border-[#5B4BFF]/20 font-extrabold uppercase text-[9px] tracking-wider inline-block">
                              {fac.staff_type}
                            </span>
                            <p className="text-[10px] text-[#7B8794] font-mono">{fac.email}</p>
                          </div>
                        </td>
                        <td className="py-4">
                          <div className="space-y-1">
                            <span className="px-2.5 py-0.5 rounded-md bg-[#F3EEFF] text-[#7C3AED] border border-[#7C3AED]/20 font-extrabold text-[10px] inline-block">
                              {fac.department_name || 'No Dept'}
                            </span>
                            <p className="text-[10px] text-[#7B8794] font-medium">
                        ...
                        <td className="py-4">
                          <div>
                            <p className="font-semibold text-[#1B1E28]">{fac.phone || 'No Mobile'}</p>
                            <p className="text-[10px] text-[#7B8794] font-medium">{fac.experience ? `${fac.experience} Exp.` : 'Exp: N/A'}</p>
                          </div>
                        </td>
                        <td className="py-4">
                          <span className={`px-2.5 py-0.5 rounded-full font-extrabold uppercase text-[9px] tracking-wide inline-block ${
                            fac.is_active 
                              ? 'bg-[#EDFFF8] text-[#00C48C] border border-[#00C48C]/30' 
                              : 'bg-[#FFF2F2] text-[#F04438] border border-[#F04438]/30'
                          }`}>
                        ...
                        <td className="pr-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="p-2 rounded-xl bg-[#EEF2FF] hover:bg-[#5B4BFF] text-[#5B4BFF] hover:text-white transition-all border border-[#5B4BFF]/20 shadow-sm"
                            ...
                            <button
                              ...
                              className="p-2 rounded-xl bg-[#FFF2F2] hover:bg-[#F04438] text-[#F04438] hover:text-white transition-all border border-[#F04438]/20 shadow-sm"
            ...
            {/* Pagination footer */}
            {totalPages > 1 && (
              <div className="px-6 py-4 flex items-center justify-between border-t border-[#E7EAF3] bg-[#F6F8FC]">
                <span className="text-[11px] text-[#4E5969] font-semibold">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3.5 py-1.5 rounded-xl bg-white hover:bg-[#EEF2FF] hover:text-[#5B4BFF] border border-[#E7EAF3] text-[11px] font-bold disabled:opacity-40 transition-all text-[#4E5969] shadow-sm"
                  >
                    Previous
                  </button>
                  <button
      ...
      {/* ULTRA-PREMIUM MODAL WITH LIVE PREVIEW */}
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1B1E28]/60 backdrop-blur-sm animate-fade-in">
          <div className="relative w-full max-w-4xl overflow-hidden shadow-2xl rounded-[22px] bg-white border border-[#E7EAF3] text-[#1B1E28] flex flex-col max-h-[92vh]">
            ...
            <div className="bg-gradient-to-r from-[#2D2575] via-[#3A2F8A] to-[#5B4BFF] px-6 py-4 border-b border-white/10 flex items-center justify-between">
              <div>
                ...
                <p className="text-[11px] text-white/70 font-medium mt-0.5">Provide administrative credentials, department links, and role assignments.</p>
              </div>
              <button 
                onClick={() => setIsModalOpen(false)}
                className="p-2 rounded-xl bg-white/10 text-white/80 hover:text-white hover:bg-white/20 border border-white/20 transition-all"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-hidden flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-80 border-r border-[#E7EAF3] p-6 flex flex-col justify-between bg-[#F6F8FC] space-y-6">
                
                {/* Live Card Preview */}
                <div className="w-full space-y-3">
                  <span className="text-[10px] font-black uppercase text-[#2D2575] tracking-wider">Live Profile Card</span>
                  
                  <div className="w-full rounded-[20px] bg-white border border-[#E7EAF3] p-5 flex flex-col items-center text-center space-y-3 relative overflow-hidden shadow-md">
                    ...
                    <div className="w-24 h-24 rounded-full p-1 bg-gradient-to-tr from-[#2D2575] via-[#5B4BFF] to-[#F36C21] shadow-md relative group mt-2">
                      <div className="w-full h-full rounded-full bg-[#EEF2FF] overflow-hidden flex items-center justify-center relative">
                        {photoPreview ? (
                          <>
                          ...
                          <div className="flex flex-col items-center justify-center p-2 text-[#7B8794]">
                            ...
                            <span className="text-[8px] font-bold uppercase tracking-wider text-[#9BA5B5]">No Photo</span>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="w-full space-y-0.5">
                      <h4 className="font-black text-base text-[#1B1E28] tracking-tight leading-snug truncate">
                        {formData.name || 'Full Name'}
                      </h4>
                      <p className="text-[11px] text-[#5B4BFF] font-bold uppercase tracking-wider">
                        {formData.designation || 'Designation'}
                      </p>
                      <p className="text-[10px] text-[#2D2575] font-mono font-bold tracking-widest mt-1 bg-[#EEF2FF] px-2.5 py-0.5 rounded-lg border border-[#5B4BFF]/20 inline-block">
                        {formData.empId || 'EMPCODE'}
                      </p>
                    </div>

                    <div className="pt-3 border-t border-[#E7EAF3] w-full flex flex-col items-center gap-1.5">
                      <span className="px-2.5 py-0.5 rounded-md bg-[#EEF2FF] text-[#5B4BFF] border border-[#5B4BFF]/20 font-extrabold uppercase text-[9px] tracking-wider">
                ...
                <div className="w-full space-y-2 pt-2 border-t border-[#E7EAF3]">
                  <span className="text-[10px] font-black uppercase text-[#2D2575] tracking-wider">Upload Profile Photo</span>
                  <label className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-[#5B4BFF]/30 hover:border-[#5B4BFF] rounded-2xl cursor-pointer bg-white hover:bg-[#EEF2FF]/40 transition-all p-3 text-center group shadow-sm">
                    ...
                    <span className="text-[11px] text-[#1B1E28] font-bold">Upload Photo File</span>
                    <span className="text-[9px] text-[#7B8794] mt-0.5">PNG, JPG up to 2MB (Base64)</span>
                    <input 
                      type="file" 
                      accept="image/*" 
              ...
              <div className="flex-1 p-6 overflow-y-auto space-y-5 bg-white">
                ...
                <div className="space-y-3.5">
                  <h3 className="text-[11px] font-black uppercase text-[#2D2575] tracking-wider border-b border-[#E7EAF3] pb-1.5 flex items-center gap-1.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    {/* Staff Code */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase text-[#4E5969] tracking-wider">Staff Code *</label>
                      <input
                        type="text"
                        required
                        ...
                        className="w-full px-4 py-2.5 rounded-xl bg-[#F6F8FC] border border-[#E7EAF3] focus:outline-none focus:border-[#5B4BFF] focus:ring-2 focus:ring-[#5B4BFF]/10 text-xs text-[#1B1E28] placeholder:text-[#9BA5B5] transition-all font-medium disabled:opacity-60"
                      />
                    </div>

                    {/* Faculty Name */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase text-[#4E5969] tracking-wider">Faculty Name *</label>
                      <input
                        type="text"
                        required
                        value={formData.name}
                    ...
                    {/* Email Address */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase text-[#4E5969] tracking-wider">Email Address *</label>
                      <input
                        type="email"
                        required
                        disabled={!!editingItem}
                    ...
                    {/* Password */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase text-[#4E5969] tracking-wider">
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    {/* Staff Type */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase text-[#4E5969] tracking-wider">Staff Type *</label>
                      <select
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase text-[#4E5969] tracking-wider">Designation *</label>
                      <select
                    ...
                    {selectedDesignationOption === 'Other / Custom' && (
                      <div className="space-y-1.5 sm:col-span-2">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 rounded-xl bg-[#F6F8FC] border border-[#5B4BFF]/50 focus:outline-none focus:border-[#5B4BFF] focus:ring-2 focus:ring-[#5B4BFF]/10 text-xs text-[#1B1E28] placeholder:text-[#9BA5B5] transition-all font-medium"
                        />
                      </div>
                    )}
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {/* Gender */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase text-[#4E5969] tracking-wider">Gender</label>
                      <select
                    ...
                    {/* Experience */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase text-[#4E5969] tracking-wider">Experience</label>
                      <input
                        type="text"
                    ...
                    {/* Mobile Phone */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase text-[#4E5969] tracking-wider">Mobile Phone</label>
                      <input
                        type="text"
                ...
                <div className="flex items-center justify-between pt-5 border-t border-[#E7EAF3]">
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-4 h-4 rounded text-[#5B4BFF] focus:ring-[#5B4BFF] border-[#E7EAF3] cursor-pointer"
                    />
                    <label htmlFor="isActiveToggle" className="text-xs font-extrabold uppercase text-[#1B1E28] tracking-wider cursor-pointer select-none">
