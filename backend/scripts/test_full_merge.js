...
async function main() {
  ...
  `);
  console.log('topicSubmissions:', topicSubmissions.rows.length);
  ...
  `);
  console.log('miniProjects:', miniProjects.rows.length);
  ...
  `);
  console.log('weeklyLogs:', weeklyLogs.rows.length);
  ...
  console.log('All titles:', all.map(i => ({ title: i.activity_title, cat: i.category_code, student: i.student_name })));
